...
#define _Pi                             3.14159265359
    ...
    /****************************** ODOMETRIE *********************************/
    /**************************************************************************/
    #define _ENTRAXE_MM                  300.5  //306.9   //306.2 //308.6     //Pas assez tourné -> augmenter entraxe
    #define _DIAMETRE_ROUE_CODEUSE       52.264 //51.85  //52.2 //51.68 //52.9 //52.91 //52.92 //51.971
    #define _PERIMETRE_ROUE_MM           (_DIAMETRE_ROUE_CODEUSE * _Pi) //194.455      // Si distance parcourue trop grande -> Augmenter la taille des roues
        ...
        //+COEF_D -> + a droite
    #define  _COEF_G                    (double) 1.         //tester    1.000875  (pcd 1.00085 trop à droite)      //0.99985//0.9975 //SI tourne trop a droite : augmenter
    //1.00531 474                                               //          1.000875 trop
    #define  _COEF_D                    (double) 1.    //si tourne trop a gauche: augmenter
                                                         //040 - 045
    ...
    #define _VITESSE_CONSIGNE_MAX_MM     2.5 //4. now
    #define _VITESSE_DISTANCE_MIN        0.75
    #define _VITESSE_MAX_MM_TENSION      6. //4.
    #define _DISTANCE_CONSIGNE_MM        500. 

    #define _ACC_POSITION_CONSIGNE       3. //2. now //5. //3.
    #define _DCC_POSITION_CONSIGNE       4. //2.now //8
    #define _ACC_POSITION_MIN            1.5
    #define _DCC_POSITION_MIN            1.5// 1.75now //1.5
    ...
    //PID
    #define _VITESSE_DIS_KP              0.45  //0.4 //0.45 //0.60 //0.80 //0.46
    #define _VITESSE_DIS_KI              0.05 //0.02
    #define _VITESSE_DIS_KD              0.35 //0.35 //0.32
    ...
    /****************************** ODOMETRIE *********************************/
    /**************************************************************************/
    #define _ENTRAXE_MM                  169.75 //Pas assez tourné -> augmenter entraxe
    #define _DIAMETRE_ROUE_CODEUSE       51.9715   //51.9715     //Toujours dans le sens de l'erreur : aller plus loin = diminuer D
    #define _PERIMETRE_ROUE_MM           195.4 //194.91// Si distance parcourue trop grande -> Augmenter la taille des roues

    //+COEF_D -> + a droite
    #define  _COEF_D                    (double) 0.9964 //346  //1.00372     1.004 gauche x=1.003  1.0025droite //augmente = + devie a gauche
    #define  _COEF_G                    (double) 1.0000     //augmente = + devie a droite

    /**************************************************************************/
    /******************************** ASSERV **********************************/
    /**************************************************************************/
        //Association distance - Vitesse - Accélérations max
    #define _VITESSE_CONSIGNE_MAX_MM     2. //1. //2. //2.8 
    ...
    #define _DCC_POSITION_CONSIGNE       2.5 //2.8//0.5  
    ...
    #define _MAX_ERREUR_INTEGRALLE_V     10000. //3500.
    ...
    //PID
    #define _VITESSE_DIS_KP              0.8     //0.8 //1 //0.8 //1.5 //0.8 
    #define _VITESSE_DIS_KI              0.03 //0.08//0.082 //0.13 //0.3 //0.1 //0.05 //0.02 //0.045
    #define _VITESSE_DIS_KD              0.8 //0.8//0.9 //1.0 //0.8 //0.5 //0.2
    ...
    #define KP_BRAKE                    0.08 //0.03//0.09//0.058//0.04
    #define KI_BRAKE                    0.0005 //0.0015
    #define KD_BRAKE                    0.8 //0.00333 //1.2 //0.8
    ...
    #define _ETAT_ADV_AVANT_G            ETAT_HAUT
    #define _ETAT_ADV_AVANT_D            ETAT_BAS //ETAT_BAS
    #define _ETAT_ADV_AVANT_C            ETAT_HAUT

    #define _CAPT_ADV_ARRIERE_G          CAPTEUR6
    #define _CAPT_ADV_ARRIERE_C          AUCUN
    #define _CAPT_ADV_ARRIERE_D          CAPTEUR4

    #define _ETAT_ADV_ARRIERE_G          ETAT_HAUT
    #define _ETAT_ADV_ARRIERE_C          ETAT_HAUT
    #define _ETAT_ADV_ARRIERE_D          ETAT_HAUT //ETAT_BAS
